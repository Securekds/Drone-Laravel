                  ...
                  <div class="max-w-6xl w-full">
                    ...
                    <div 
                      :class="[
                        ...
                        slide.alignment === 'center' ? 'text-center' : slide.alignment === 'right' ? 'text-right ml-auto max-w-[330px] lg:max-w-[540px]' : ''
                      ]"
                    >
                      ...
                      <div 
                        ...
                        :class="[
                          ...
                          slide.droneImage.position === 'left' ? '-top-8 -left-4' : '-top-8 -right-4',
